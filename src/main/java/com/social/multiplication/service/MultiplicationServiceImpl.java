...
public class MultiplicationServiceImpl implements MultiplicationService {
	...
	private MultiplicationRepository multiplicationRepsitory;
	private EventDispatcher eventDispatcher;

	@Autowired
	public MultiplicationServiceImpl(final RandomGeneratorService randomGeneratorService,
			final MultiplicationResultAttemptRepository attemptRepository, final UserRepository userRepository,
			final MultiplicationRepository multiplicationRepsitory, final EventDispatcher eventDispatcher) {
		this.randomGeneratorService = randomGeneratorService;
		this.attemptRepository = attemptRepository;
		this.userRepository = userRepository;
		this.multiplicationRepsitory = multiplicationRepsitory;
	...
	public boolean checkAttempt(final MultiplicationResultAttempt attempt) {
		...
		Optional<Multiplication> multiplication = multiplicationRepsitory.findByResult(attempt.getResultAttempt());
